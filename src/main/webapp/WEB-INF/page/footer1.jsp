						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									...
									<li><a href="#"><i class="fa fa-envelope-o"></i>care@kalababa.com</a></li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<span class="copyright">
								...
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | RedoJet.com
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
						</div>
					</div>
